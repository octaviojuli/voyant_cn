...
export const productsUiCoreEn = {
  ...
  routeImportPage: {
    ...
    description:
      "Upload a Word or PDF route document, review the parsed draft, then create the product.",
    upload: {
      label: "Upload a route document",
      hint: "Word (.docx) and PDF, up to 20 MB each",
      button: "Choose file",
      uploading: "Parsing…",
      failed: "Could not parse the document",
    },
    empty: "No drafts yet. Upload a route document to start.",
    columns: {
      file: "Source file",
      route: "Route",
      days: "Days",
    ...
    detail: {
      ...
      routeMap: "Route overview",
      routeMapEmpty: "Fewer than two overnight cities — no route map to draw.",
      basics: "Basics",
      ...
      unresolvedHint: "These could not be parsed from the document. Fill them in by hand.",
      meals: "Meals",
      accommodation: "Accommodation",
      distance: "Distance and drive time",
      noContent: "Not in the document",
      day: "Day {day}",
      save: "Save changes",
      saving: "Saving…",
      saved: "Saved",
      commit: "Create product",
      committing: "Creating product…",
      committed: "Product created",
      commitHint:
        "Creates a draft product. Price and price rules are left empty — set them on the product page before publishing.",
      commitFailed: "Not ready yet — fix the issues below",
