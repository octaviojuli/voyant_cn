...
export const productsUiCoreRo = {
  ...
  routeImportPage: {
    ...
    description:
      "Incarca un document Word sau PDF cu traseul, verifica schita rezultata, apoi creeaza produsul.",
    upload: {
      label: "Incarca un document de traseu",
      hint: "Word (.docx) si PDF, maximum 20 MB fiecare",
      button: "Alege fisierul",
      uploading: "Se analizeaza…",
      failed: "Documentul nu a putut fi analizat",
    },
    empty: "Nicio schita inca. Incarca un document de traseu pentru a incepe.",
    columns: {
      file: "Fisier sursa",
      route: "Traseu",
      days: "Zile",
    ...
    status: {
      pending_review: "Asteapta verificare",
      in_review: "In verificare",
      committed: "Publicat",
      discarded: "Renuntat",
    },
    detail: {
      back: "Inapoi la schite",
      sourceFile: "Fisier sursa",
      routeMap: "Prezentare traseu",
      routeMapEmpty: "Mai putin de doua orase de innoptare - nu se poate desena traseul.",
      basics: "Date generale",
      itinerary: "Zi cu zi",
      pricing: "Pret",
      inclusions: "Ce include",
      exclusions: "Ce nu include",
      terms: "Note de rezervare",
      unresolved: "Necesita atentie",
      unresolvedHint: "Acestea nu au putut fi extrase din document. Completeaza-le manual.",
      meals: "Mese",
      accommodation: "Cazare",
      distance: "Distanta si timp de condus",
      noContent: "Lipseste din document",
      day: "Ziua {day}",
      save: "Salveaza modificarile",
      saving: "Se salveaza…",
      saved: "Salvat",
      commit: "Creeaza produsul",
      committing: "Se creeaza produsul…",
      committed: "Produs creat",
      commitHint:
        "Creeaza un produs in stare de schita. Pretul si regulile de pret raman goale - completeaza-le pe pagina produsului inainte de publicare.",
      commitFailed: "Inca nu este gata - corecteaza problemele de mai jos",
      openProduct: "Deschide produsul",
      discard: "Renunta la aceasta schita",
      discarded: "Renuntat",
    },
  },
  productDetailPage: {
