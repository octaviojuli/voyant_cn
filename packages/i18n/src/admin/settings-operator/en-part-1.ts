export const operatorAdminSettingsMessagesEnPart1 = {
  ...
  routeImport: "Route import assistant",
  ...
  routeImportPage: {
    ...
    description:
      "Defaults the assistant uses when creating a product from an uploaded route document.",
    resolvedTitle: "What the assistant will use",
    resolvedHint: "Empty fields fall back to these values.",
    sellCurrency: "Sell currency",
    timezone: "Time zone",
    productType: "Product type",
    defaultSupplier: "Default supplier",
    supplierHint: "Pre-selected on the review page; change it per document before confirming.",
    adultMinAge: "Adult from age",
    childMinAge: "Child from age",
    ageHint: "Below the child age counts as an infant and is priced separately.",
    save: "Save",
    saving: "Saving…",
    saved: "Saved",
    unset: "Not set",
