export const operatorAdminProductsMessagesRoCore = {
  ...
  rrule: {
    ...
    everyNDays: "La fiecare {n} zile",
    everyWeek: "In fiecare saptamana",
    everyNWeeks: "La fiecare {n} saptamani",
    everyMonth: "In fiecare luna",
    everyNMonths: "La fiecare {n} luni",
    everyWeekdayFull: "In fiecare {weekday}",
    onWeekdays: "{cadence}, in zilele {days}",
    onMonthDay: "{cadence}, in ziua {days}",
    onMonthDays: "{cadence}, in zilele {days}",
    noWeekdays: "{cadence} (fara zile)",
    noMonthDays: "{cadence} (fara zile)",
    listSeparator: ", ",
    weekdayShort: {
      MO: "Lun",
      TU: "Mar",
