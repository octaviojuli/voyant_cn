...
export const storefrontMessagesRo: StorefrontMessages = {
  ...
  shopDetailCruises: {
    ...
    shipTypeOcean: "Ocean",
    shipTypeRiver: "Fluvială",
    shipTypeExpedition: "Expediție",
    shipTypeYacht: "Iaht",
    shipTypeSailing: "Velier",
    shipTypeCoastal: "De coastă",
    cabinTypeInside: "Interioară",
    cabinTypeOceanview: "Vedere la ocean",
    cabinTypeBalcony: "Balcon",
    cabinTypeSuite: "Suită",
    cabinTypePenthouse: "Penthouse",
    cabinTypeSingle: "Single",
  },
  shopDetailProducts: {
